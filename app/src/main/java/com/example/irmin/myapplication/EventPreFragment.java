...
public class EventPreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            task.execute("http://irmin95.cafe24.com/EventListPre.php?userID=" + URLEncoder.encode(userID,"UTF-8") + "&now=" +URLEncoder.encode(strNow,"UTF-8"));
        } catch (Exception e) {
            e.printStackTrace();
        }
